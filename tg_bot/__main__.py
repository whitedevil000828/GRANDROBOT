...
TECHNO_IMG = "https://telegra.ph/file/9f53aa8819d9aadda44ea.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/RoyalRk_1012")],
                                                                                   [InlineKeyboardButton(text="ADD ROYAL_GROUP_BOT TO YOUR GROUP",
        ...
        update.effective_message.reply_text("ZINDHA HU MERE BAHI")
